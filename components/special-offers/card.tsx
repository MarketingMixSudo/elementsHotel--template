...
const Card = () => {
	return (
		<Link href="#" className='h-[420px] lg:h-[550px] 2xl:h-[650px] bg-white flex justify-start items-end w-full relative group overflow-hidden'>
...
<div className='bg-primary-600 absolute top-[45px] -right-[65px] w-[290px] uppercase rotate-[42deg] z-20 py-2.5 px-8 text-center'>
    ...
    Grill w cenie
			...
			<Image src={easter} alt='morning image' fill className='w-full h-full object-cover object-center group-hover:scale-110 transition-all duration-300 ' />
